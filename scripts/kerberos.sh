...
#spnegeo.service.keytab, estara en la carpeta donde ejecutamos
mkdir -p security/keytabs/
sudo chown -R root:vagrant ~/security/keytabs
sudo chmod -R 750 ~/security/keytabs/
# en eel server
