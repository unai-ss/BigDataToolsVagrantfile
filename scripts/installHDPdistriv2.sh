...
sh -c "echo HADOOP_CONF_DIR=$HADOOP_HOME/etc/hadoop >> ~/.bashrc"
sh -c "echo HADOOP_MAPRED_HOME=$HADOOP_HOME >> ~/.bashrc"
sh -c "echo HADOOP_COMMON_HOME=$HADOOP_HOME >> ~/.bashrc"
sh -c "echo HADOOP_HDFS_HOME=$HADOOP_HOME >> ~/.bashrc"
sh -c "echo YARN_HOME=$HADOOP_HOME >> ~/.bashrc"
sh -c "echo PATH=$PATH:$HADOOP_HOME/sbin:$HADOOP_HOME/bin >> ~/.bashrc"
...
chown -R vagrant:vagrant ~/hadoop_store
